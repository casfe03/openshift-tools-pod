...
RUN yum install -y httpd php wget iproute iputils net-tools netsniff-ng bind-utils bc bind-utils nmap-ncat crash e2fsprogs ethtool file glibc-utils hwloc ltrace tcpdump xfsprogs curl bash-completion && yum clean all
