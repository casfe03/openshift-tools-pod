...
RUN yum install -y httpd php wget iproute iputils net-tools bind-utils bc bind-utils nmap-ncat ethtool file traceroute curl bash-completion && yum clean all
